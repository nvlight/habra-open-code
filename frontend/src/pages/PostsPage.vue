<template>
  <div>
    <div class="tm-section-name">
      <h1 class="tm-section-name__text">Посты</h1>
    </div>

    <div class="tm-tabs">
      <router-link to="/articles" class="tm-tabs__item">Статьи</router-link>
      <router-link to="/posts" class="tm-tabs__item tm-tabs__item--active">Посты</router-link>
...
async function load(): Promise<void> {
  loading.value = true;
  try {
    const params: Record<string, string | number> = { page: page.value, per_page: 20, sort: sort.value, type: 'post' };
