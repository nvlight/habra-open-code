<template>
  <q-card flat class="habr-card q-pa-md" style="max-width: 860px; margin: 0 auto">
...
async function loadExisting(): Promise<void> {
  ...
  try {
    ...
    Object.assign(form, {
      ...
      source_url: null,
      original_author: pub.original_author ?? null,
      hubs: pub.hubs.map((h) => h.id),
      tags: []
    });
