<template>
  <div>
    ...
    <div class="tm-section-name">
      <h1 class="tm-section-name__text">Статьи</h1>
    </div>

    <!-- Tabs -->
    <div class="tm-tabs">
      <router-link to="/articles" class="tm-tabs__item tm-tabs__item--active">Статьи</router-link>
      <router-link to="/posts" class="tm-tabs__item">Посты</router-link>
      <router-link to="/news" class="tm-tabs__item">Новости</router-link>
    ...
    <div class="tm-filters">
      <div class="tm-filters__row">
        ...
        <button
          ...
          :class="{ 'tm-filter-chip--active': sort === 'new' }"
          @click="setSort('new')"
        >Новые</button>
        <button
          class="tm-filter-chip"
          :class="{ 'tm-filter-chip--active': sort === 'best' }"
          @click="setSort('best')"
        >Лучшие</button>
      </div>
      <div class="tm-filters__row">
        ...
        <button
          ...
          :key="rating.label"
          class="tm-filter-chip"
          :class="{ 'tm-filter-chip--active': minRating === rating.value }"
    ...
    <template v-else>
      ...
      />
      <div v-if="publications.length === 0" class="tm-empty">
        Ничего не найдено
      </div>
    </template>
